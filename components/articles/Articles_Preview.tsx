...
import { Author, AuthorArea, AuthorCard } from "./Author";
import {
    FullScreenShuriken,
    h1TitleCss,
    Layout,
...
import { FBShareBtn, TwitterShareBtn } from "./SnsShareButton";
...
export function Articles_Preview(props: ArticlesProps) {
