...
const badNinja = APPS_PUBLIC_IMG_URL + "ninja_bad.png";
const rock = APPS_PUBLIC_IMG_URL + "rockRight.png";
const fire = APPS_PUBLIC_IMG_URL + "fireRight.png";
const flyingNinja = APPS_PUBLIC_IMG_URL + "flying-ninja.png";
const runningNinja = APPS_PUBLIC_IMG_URL + "ninja_hashiru.png";
